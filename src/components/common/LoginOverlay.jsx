...
export default function LoginOverlay({ className = '', style, title = 'Log in to explore the Moon', sub = 'Create a free account to start building.', ctaHref = '/registration', ctaText = 'Go to Login / Register' }) {
  return (
