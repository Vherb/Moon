...
function App() {
  ...
  return (
    <>
      ...
      <style>{`
        :root { --nav-height: 56px; --footer-h: 52px; }
    ...
    <footer ref={ref} className="theme-footer" role="contentinfo" aria-label="Site footer">
      <div className="theme-footer-inner">
        <div className="footer-left">
          ...
          <div className="tagline d-none d-md-block">A sandbox moon adventure</div>
        </div>
        <nav className="footer-center" aria-label="Footer">
          <a href="/" className="text-link">Home</a>
          <span className="sep">•</span>
          <a href="/rooms" className="text-link">Rooms</a>
          <span className="sep d-none d-sm-inline">•</span>
          <a href="/connect-four" className="text-link d-none d-sm-inline">Quick Play</a>
          <span className="sep d-none d-sm-inline">•</span>
